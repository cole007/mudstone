...
},{"./dependencies/load-behaviour":2,"./modules/menu":7,"jquery":8,"webfontloader":9}],2:[function(require,module,exports){
'use strict';
...
},{"../dependencies/namespace":3,"jquery":8}],3:[function(require,module,exports){
'use strict';
...
var animate = {
	animateIn: function animateIn(el, func) {
		var activeClassName = arguments.length <= 2 || arguments[2] === undefined ? 'is-active' : arguments[2];
		var animateClassName = arguments.length <= 3 || arguments[3] === undefined ? 'is-animating-in' : arguments[3];
	...
	animateOut: function animateOut(el, func) {
		var activeClassName = arguments.length <= 2 || arguments[2] === undefined ? 'is-active' : arguments[2];
		var animateClassName = arguments.length <= 3 || arguments[3] === undefined ? 'is-animating-out' : arguments[3];
	...
	animateInAnimdateOut: function animateInAnimdateOut(options) {
		...
		function open() {
			_this.animateIn((0, _jquery2.default)(el), function () {
		...
		function close() {
			_this.animateOut((0, _jquery2.default)(el), function () {
...
},{"../helpers/prefix":5,"jquery":8}],5:[function(require,module,exports){
'use strict';
...
function menu(container) {
	...
	function clickHandle(e) {
		e.preventDefault();
		_animate2.default.animateInAnimdateOut({
			el: '.js-menu',
...
},{"../helpers/animate":4,"../helpers/utils":6,"jquery":8}],8:[function(require,module,exports){
/*!
